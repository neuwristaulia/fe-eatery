      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-secondary-foreground/80 mt-4 leading-relaxed max-w-xs text-sm">
              Menyajikan cita rasa autentik Kopitiam modern dengan sentuhan oriental premium. Good Food, Good Mood.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-secondary-foreground/80">
              <li><Link href="/dashboard" className="hover:text-accent transition-colors">Home</Link></li>
              <li><Link href="/menu" className="hover:text-accent transition-colors">Menu</Link></li>
              <li><Link href="#promo" className="hover:text-accent transition-colors">Promo</Link></li>
          ...
          {/* Opening Hours */}
          <div>
            <h3 className="font-serif font-bold text-lg text-white mb-6">Opening Hours</h3>
            <ul className="space-y-3 text-sm text-secondary-foreground/80">
        ...
        <div className="pt-8 border-t border-white/10 text-center md:flex justify-between items-center">
          ...
          <div className="flex justify-center gap-6 mt-4 md:mt-0 text-sm text-secondary-foreground/60">
            ...
            <Link href="/admin" className="hover:text-white transition-colors font-medium">Admin Panel</Link>
          </div>
        </div>
      </div>
    </footer>
