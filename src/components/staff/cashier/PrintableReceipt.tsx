...
export const PrintableReceipt = React.forwardRef<
  HTMLDivElement,
...
>(({ order, cashierName }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className="print-section font-mono text-black bg-white p-4 max-w-[80mm] mx-auto text-sm"
    >
      {/* Header */}
      <div className="text-center mb-6">
        {/* Anda bisa ganti logo image jika ada: <img src="/logo.png" className="mx-auto w-12 h-12 mb-2" /> */}
        <h1 className="font-bold text-xl mb-1">Kedai Loman</h1>
      ...
      <div className="text-center mt-6 text-xs">
        ...
        <p className="mt-4">Wifi: KedaiLoman_Guest / Pass: eeatery</p>
      </div>
    </div>
  );
});
